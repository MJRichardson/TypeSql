...
// $ANTLR 3.4 C:\\Users\\mjr\\src\\TypeSql\\TypeSql\\Parsing\\ANTLR\\DaoTransform.g 2012-12-13 18:04:25
...
internal partial class DaoTransform : Antlr.Runtime.Tree.TreeParser
{
	...
	public override string GrammarFileName { get { return "C:\\Users\\mjr\\src\\TypeSql\\TypeSql\\Parsing\\ANTLR\\DaoTransform.g"; } }
	...
	// $ANTLR start "sql"
	// C:\\Users\\mjr\\src\\TypeSql\\TypeSql\\Parsing\\ANTLR\\DaoTransform.g:19:8: public sql[string name, string rawSql] : ^( SQL ( outputToken | inputToken | . )* ) -> dao(name=nameoutputTokens=outputTokensinputTokens=inputTokensrawSql=rawSql);
	[GrammarRule("sql")]
	public TemplateTreeRuleReturnScope<StringTemplate, CommonTree> sql(string name, string rawSql)
	{
		...
		try
		{
			// C:\\Users\\mjr\\src\\TypeSql\\TypeSql\\Parsing\\ANTLR\\DaoTransform.g:24:2: ( ^( SQL ( outputToken | inputToken | . )* ) -> dao(name=nameoutputTokens=outputTokensinputTokens=inputTokensrawSql=rawSql))
			DebugEnterAlt(1);
			// C:\\Users\\mjr\\src\\TypeSql\\TypeSql\\Parsing\\ANTLR\\DaoTransform.g:24:4: ^( SQL ( outputToken | inputToken | . )* )
			{
			DebugLocation(24, 4);
			DebugLocation(24, 6);
			...
			if (input.LA(1) == TokenTypes.Down)
			{
				...
				DebugLocation(24, 10);
				// C:\\Users\\mjr\\src\\TypeSql\\TypeSql\\Parsing\\ANTLR\\DaoTransform.g:24:10: ( outputToken | inputToken | . )*
				...
				while (true)
				{
					...
					case 1:
						DebugEnterAlt(1);
						// C:\\Users\\mjr\\src\\TypeSql\\TypeSql\\Parsing\\ANTLR\\DaoTransform.g:25:4: outputToken
						{
						DebugLocation(25, 4);
					...
					case 2:
						DebugEnterAlt(2);
						// C:\\Users\\mjr\\src\\TypeSql\\TypeSql\\Parsing\\ANTLR\\DaoTransform.g:26:6: inputToken
						{
						DebugLocation(26, 6);
					...
					case 3:
						DebugEnterAlt(3);
						// C:\\Users\\mjr\\src\\TypeSql\\TypeSql\\Parsing\\ANTLR\\DaoTransform.g:27:6: .
						{
						DebugLocation(27, 6);
						MatchAny(input); 
	...
	// C:\\Users\\mjr\\src\\TypeSql\\TypeSql\\Parsing\\ANTLR\\DaoTransform.g:34:1: outputToken returns [OutputToken token] : ^( OUTPUT_TOKEN id= ID type= ID ) ;
	...
	private DaoTransform.outputToken_return outputToken()
	{
		...
		try
		{
			// C:\\Users\\mjr\\src\\TypeSql\\TypeSql\\Parsing\\ANTLR\\DaoTransform.g:35:2: ( ^( OUTPUT_TOKEN id= ID type= ID ) )
			DebugEnterAlt(1);
			// C:\\Users\\mjr\\src\\TypeSql\\TypeSql\\Parsing\\ANTLR\\DaoTransform.g:35:4: ^( OUTPUT_TOKEN id= ID type= ID )
			{
			DebugLocation(35, 4);
			DebugLocation(35, 6);
	...
	// C:\\Users\\mjr\\src\\TypeSql\\TypeSql\\Parsing\\ANTLR\\DaoTransform.g:38:1: inputToken returns [InputToken token] : ^( INPUT_TOKEN id= ID type= ID ) ;
	...
	private DaoTransform.inputToken_return inputToken()
	{
		...
		try
		{
			// C:\\Users\\mjr\\src\\TypeSql\\TypeSql\\Parsing\\ANTLR\\DaoTransform.g:39:2: ( ^( INPUT_TOKEN id= ID type= ID ) )
			DebugEnterAlt(1);
			// C:\\Users\\mjr\\src\\TypeSql\\TypeSql\\Parsing\\ANTLR\\DaoTransform.g:39:4: ^( INPUT_TOKEN id= ID type= ID )
			{
			DebugLocation(39, 4);
			DebugLocation(39, 6);
